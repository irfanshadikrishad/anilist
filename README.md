...
| `social` <br> _(alias: `sol`)_          | `-f, --follow` <br> `-u, --unfollow` <br> `-i, --inactive <months>`     | Follow users who follows you, unfollow who doesn't follow you back, or unfollow stale/inactive accounts |
...
- Options:
  ...
  - `-i, --inactive <months>`: To unfollow users you follow who haven't posted any activity in the given number of months, to help clear out stale/inactive accounts.
- Description: It follows users who follows you, unfollows users who doesn't follow you back, or unfollows stale accounts with no recent activity, all at ease.
